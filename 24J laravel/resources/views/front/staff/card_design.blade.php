<div class="custom_card"  >
    ...
    <div class="make_iframe">

        <div class="loader_img_cls">
            <div id="ajax_loader" style="display: none;">
                <img src="{{asset('frontassets/image/loading-gif.gif')}}">
            </div>
        </div>

        <div class="staff_profile_img">
            <?php 
                if( @$get_staff['avatar_img_url'] != '' ){ 

                    if(@$get_staff['avatar_file'] != ''){
                        ?>
                        <img src="{{ $get_staff['avatar_img_url'] != '' ?  $get_staff['avatar_img_url'] : asset('frontassets/image/default-avatar.svg') }}" />
                        <?php
                    }else{
                        ?>
                        <img src="{{ $get_staff['avatar_img_url'] != '' ? asset('uploads/staff/' . $get_staff['avatar_img_url']) : asset('frontassets/image/default-avatar.svg') }}">
                        <?php
                    }
                }else{
                    ...
                    ?>
                        <img src="{{asset('frontassets/image/default-avatar.svg')}}">
                    <?php
                    }
                }
            ?>
                    ...
                    <?php 
                        if( @$get_staff['company_logo_url'] != '' ){ 
                            ...
                            if(@$get_staff['company_logo'] != ''){
                                ?>
                                <img class="company_logo" src="{{ $get_staff['company_logo_url'] != '' ? $get_staff['company_logo_url'] : asset('frontassets/image/logo.png') }}" />
                                <?php
                            }else{
                                ?>
                                <img class="company_logo" src="{{ $get_staff['company_logo_url'] != '' ? asset('uploads/staff/' . $get_staff['company_logo_url']) : asset('frontassets/image/logo.png') }}" />
                                <?php
                            }
                        }else{
                            if(isset($get_staff['company_logo'])){
                                ?>
                                <img class="company_logo" src="{{ $get_staff['company_logo'] != '' ? asset('uploads/staff/' . $get_staff['company_logo']) : asset('frontassets/image/logo.png') }}" />
                                <?php
                            }else{
                            ?>
                                <img class="company_logo" src="{{asset('frontassets/image/logo.png')}}">
                            <?php
                            }
                        }
                    ?>
                                    ...
                                    <a href="{{$fb_http}}{{$get_staff['facebook']}}" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                          <g id="Group_464" data-name="Group 464" transform="translate(-3167 -912)">
                                            <path id="facebook-rect" d="M3.756,0A3.748,3.748,0,0,0,0,3.756V16.815a3.748,3.748,0,0,0,3.756,3.756h7.078V12.529H8.707v-2.9h2.126V7.16c0-1.943,1.257-3.728,4.151-3.728a17.538,17.538,0,0,1,2.038.113l-.068,2.7s-.884-.009-1.848-.009c-1.044,0-1.211.481-1.211,1.279V9.634h3.142l-.137,2.9H13.9v8.042h2.919a3.748,3.748,0,0,0,3.756-3.756V3.756A3.748,3.748,0,0,0,16.815,0Z" transform="translate(3168.714 913.714)" fill="#5e0c1c"/>
                                            <g id="Rectangle_98" data-name="Rectangle 98" transform="translate(3167 912)" fill="none" stroke="#5e0c1c" stroke-width="1" opacity="0">
                                              <rect width="24" height="24" stroke="none"/>
                                              <rect x="0.5" y="0.5" width="23" height="23" fill="none"/>
                                            </g>
                                          </g>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                          <g id="Group_467" data-name="Group 467" transform="translate(-3210 -1010)">
                                            <g id="bxl-instagram-alt" transform="translate(3211.714 1011.697)">
                                              <path id="Path_168" data-name="Path 168" d="M25,10.553a7.46,7.46,0,0,0-.478-2.532,5.266,5.266,0,0,0-3.008-3.008,7.547,7.547,0,0,0-2.5-.48c-1.1-.05-1.447-.063-4.238-.063s-3.148,0-4.238.063a7.547,7.547,0,0,0-2.5.48A5.263,5.263,0,0,0,5.037,8.021a7.487,7.487,0,0,0-.478,2.5c-.05,1.1-.064,1.449-.064,4.238s0,3.146.064,4.238a7.53,7.53,0,0,0,.478,2.5A5.266,5.266,0,0,0,8.046,24.5a7.521,7.521,0,0,0,2.5.514c1.1.05,1.449.064,4.238.064s3.148,0,4.238-.064a7.528,7.528,0,0,0,2.5-.478,5.273,5.273,0,0,0,3.008-3.008,7.5,7.5,0,0,0,.478-2.5c.05-1.1.064-1.447.064-4.238s0-3.144-.066-4.238ZM14.773,20.032a5.281,5.281,0,1,1,5.281-5.281,5.279,5.279,0,0,1-5.281,5.281ZM20.265,10.5A1.231,1.231,0,1,1,21.5,9.273,1.23,1.23,0,0,1,20.265,10.5Z" transform="translate(-4.495 -4.47)" fill="#5e0c1c"/>
                                              <path id="Path_169" data-name="Path 169" d="M20.347,16.894a3.431,3.431,0,1,1-3.431-3.431,3.431,3.431,0,0,1,3.431,3.431Z" transform="translate(-6.639 -6.614)" fill="#5e0c1c"/>
                                            </g>
                                            <g id="Rectangle_103" data-name="Rectangle 103" transform="translate(3210 1010)" fill="none" stroke="#5e0c1c" stroke-width="1" opacity="0">
                                              <rect width="24" height="24" stroke="none"/>
                                              <rect x="0.5" y="0.5" width="23" height="23" fill="none"/>
                                            </g>
                                          </g>
                                    ...
                                    <a href="{{$linkedin_http}}{{$get_staff['linkedin']}}" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                          <g id="Group_465" data-name="Group 465" transform="translate(-3167 -961)">
                                            <path id="linkedin" d="M4.67,19.664V6.4H.26V19.664Zm-2.2-15.08A2.3,2.3,0,1,0,2.495,0a2.3,2.3,0,1,0-.058,4.584h.029ZM7.11,19.664h4.41V12.255a3.019,3.019,0,0,1,.145-1.076,2.414,2.414,0,0,1,2.263-1.613c1.6,0,2.234,1.216,2.234,3v7.1h4.41V12.057c0-4.075-2.176-5.971-5.077-5.971a4.392,4.392,0,0,0-4,2.235h.03V6.4H7.111c.058,1.245,0,13.267,0,13.267Z" transform="translate(3168.714 963.168)" fill="#5e0c1c"/>
                                            <g id="Rectangle_99" data-name="Rectangle 99" transform="translate(3167 961)" fill="none" stroke="#5e0c1c" stroke-width="1" opacity="0">
                                              <rect width="24" height="24" stroke="none"/>
                                              <rect x="0.5" y="0.5" width="23" height="23" fill="none"/>
                                            </g>
                                          </g>
