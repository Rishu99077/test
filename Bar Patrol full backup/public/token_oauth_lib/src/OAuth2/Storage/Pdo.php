    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    public function __construct($connection, $config = array())
    {
        ...
        $this->config = array_merge(array(
            'client_table' => 'token_oauth_clients',
            'access_token_table' => 'token_oauth_access_tokens',
            'refresh_token_table' => 'token_oauth_refresh_tokens',
            'code_table' => 'token_oauth_authorization_codes',
            'user_table' => 'token_oauth_users',
            'jwt_table'  => 'token_oauth_jwt',
            'jti_table'  => 'token_oauth_jti',
            'scope_table'  => 'token_oauth_scopes',
            'public_key_table'  => 'token_oauth_public_keys',
        ), $config);
    }
