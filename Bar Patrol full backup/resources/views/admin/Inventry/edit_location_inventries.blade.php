                  ...
                  <div class="row" id="view_table">
                      <div class="table-responsive">
                        <table class="table table_products">
                           ...
                           <tbody id="view_pro" class="Pro_response">
                              <?php if ($get_inventryproducts!='') {
                                foreach ($get_inventryproducts as $key => $value) { ?>
                                  <tr>
                                    <input type="hidden" name="InventryID[]" class="form-control" value="{{$value['InventryID']}}"/>
               ...
               <div class="row">
                <input type="hidden" name="inventry_id" value="{{$inventry_id}}">
                  ...
                  <div class="mb-3 col-lg-6 form-group" id="Inputquantity_type">
                     ...
                     <input type="text" name="quantity_type" class="form-control"  id="quantity_type" placeholder="Enter Quantity">
                  ...
                  <div class="mb-3 col-lg-6 form-group" id="Inputcase_size">
                     ...
                     <input type="text" name="case_size" class="form-control"  id="get_ajx_case_size" placeholder="Enter Case size">
                  ...
                  <div class="mb-3 col-lg-6 form-group" id="Inputweight">
                     ...
                     <input type="number" name="weight" class="form-control"  id="get_full_weight" placeholder="Enter Weight">
                  ...
                  <div class="mb-3 col-lg-6 form-group" id="Inputwhole_sale_value">
                     ...
                     <input type="number" name="whole_sale_value" class="form-control"  id="get_whole_sale_value" placeholder="Enter Quantity">
                  ...
                  <div class="mb-3 col-lg-6 form-group" id="Inputretail_value">
                     ...
                     <input type="number" name="retail_value" class="form-control"  id="get_retail_portion_price" placeholder="Enter Retail value">
