...
@include('admin.Common.topbar')
      <div class="d-flex align-items-center justify-content-between announce_ban bg_black mb_40">
          <div class="">
            <h3 class="f24 mb-0 text-white">All Product added by <span>{{$data['user_details']['restaurant_name']}}</span></h3>
          </div>
          <div class="">
            <?php if ($data['user_details']['user_role']=='1') {?>
            <a href="{{('admin_products')}}" class="rec_btn">
              <span class="mr_10"><i class="fa fa-plus"></i> All admin products</span>
            </a>
            <?php }elseif ($data['user_details']['user_role']!='1') { ?>
              <a href="{{('master_products')}}" class="rec_btn">
                <span class="mr_10"><i class="fa fa-plus"></i> Add from master</span>
              </a>
            <?php } ?>
            <a href="{{('add_product')}}" class="rec_btn">
            ...
            <div class="col-md-2 mt-4">
              <div class="row">
                  <div class="add_inve_box col-md-12">
                      ...
                      <a id="clear" href="{{('products')}}" class="btn btn-danger clear">Clear</a>
                  </div>
              </div>
            </div>
        </div>
