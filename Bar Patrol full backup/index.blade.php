                        ...
                        <tbody>
                          <?php foreach ($value_pre as $key => $value) { ?>
                             <tr>
                                ...
                                <td><a href="{{url('delete_purchase_order')}}?PurchaseID={{$value['PurchaseID']}}" onClick="return doconfirm();"><button type="button" name="remove" id="btn_remove" class="btn btn-danger btn_remove">X</button></a></td>
                             </tr>
                          <?php } ?>
                        </tbody>
                    </table>
            ...
            <?php if (!empty($preorders)) { ?>     
              <div>
                 <div class="text-end mt_75" id="place_order">
                   <button type="submit" class="btn place_btn" onClick="return sconfirm();">Place all order <span class="count_order">{{}}</span></button>
                 </div>
              </div>
            <?php } ?>
         </form>
