...
<div class="main_right">
   ...
   <div class="contact_tabs">
      <ul class="nav nav-tabs" id="myTab" role="tablist">
         ...
         <li class="nav-item" role="presentation">
            <a class="nav-link active" id="contract-to-sign-tab" href="{{Route('seeker.contract_to_sign')}}">
      ...
      <!-- Contract to sign -->
        <div class="tab-pane fade active show" id="contract-to-sign" role="tabpanel" aria-labelledby="contract-to-sign-tab">
            <div class="job_card_wrapper_contract">
               <?php if (!empty($contracts_to_sign)) { 
                  foreach ($contracts_to_sign as $key => $value) { ?>
               <div class="job_card_contract">
                    <div class="jcard_top_contract align-items-center justify-content-between">
                        ...
                        <div class="jc_right text-end"></div>
                    </div>
            ...
            <div class="my_pagination">
               {{$get_contracts_to_sign->appends(request()->query())->links() }}
            </div>
            <?php if (empty($contracts_to_sign)) { ?>
