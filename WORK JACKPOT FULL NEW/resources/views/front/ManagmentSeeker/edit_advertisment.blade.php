...
<style type="text/css">
.sp_frm_group .site_btn {width: 100%!important;}
...
.edit_form select {width: 100%;border: none;border-bottom: 2px solid var(--purpule);padding: 10px 0;}
.sp_frm_group a.bk_btn{width: 100%;}
</style>
<div class="main_right">
    ...
    <div class="presonal-wallines radioPanel wali_ka_form">
        <form action="{{Route('add_advertisment')}}" method="post" id="Advertisment_form" class="edit_form">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-xl-4 sp_frm_group">
                    ...
                    <div class="d-flex flex-wrap justify-content-between post_job_btns">
                        ...
                        <div class="btn_half"><a href="#" class="bk_btn" onclick="goBack()"><img src="images/back.png" alt="">{{__("customer.text_back")}}</a></div>
                        <div class="btn_half"><button type="submit" class="site_btn">{{__("customer.text_update")}}</button></div>
