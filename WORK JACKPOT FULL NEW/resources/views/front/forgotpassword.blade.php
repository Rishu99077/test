...
<head>
    ...
    <title>{{__("customer.text_forgot_password")}} - {{__("customer.text_work_jackpot")}}</title>
        ...
        <section class="login_sec login_main_sec log_sign_sec py_56 mb_100">
            <div class="container">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-6">
                        <form action="{{Route('forgotpassword')}}" autocomplete="off" class="log_frm" method="post">
                          @csrf    
                            <div class="overflow_scroll mh_auto">
                                <div class="loginfrm_head">
                                    <h3 class="f32">{{__("customer.text_forgot_password")}}</h3>
                                    <p class="clr_lgrey f_medium">Lorem ipsum dolor sit amet consectetur.</p>
                                </div>
                                <div class="form_row">
                                    <label for="email">{{__("customer.text_email_phone")}}</label>
                                    <input type="email" required name="email" id="email" placeholder='{{__("customer.text_enter")}} {{__("customer.text_email_phone")}}'>
                                </div>
                                <div class="form_row text-end forget_password">
                                    <a href="{{url('login')}}" class="f14 f_medium">{{__("customer.text_login")}}?</a>
                                </div>
