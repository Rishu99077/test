    ...
    <div class="main_right">
        ...
        <div class="contact_tabs">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="payed-bills-tab"  href="{{Route('provider.documents_payed_bills')}}" aria-controls="send-sms" >
                        <span class="tab_icon_a">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <!-- Payed Bills -->
                <?php if (count($get_reports_paid)>0) { ?>
                <div class="tab-pane fade active show" id="payed-bills" role="tabpanel" aria-labelledby="payed-bills-tab">
                    <div class="job_card_wrapper_contract">
                          <?php  foreach ($get_reports_paid as $key => $value) { ?>
                        <div class="job_card_contract">
                            ...
                            <div class="jcard_top_contract align-items-center justify-content-between">
                                <div class="jc_left_s align-items-center justify-content-between">
                                    <div class="jc_left_l_bills">
                                        <span><img src="{{ asset('assets/images/write_bl.png') }}" alt="" class="bills-image"></span>
                                    </div>
                                </div>
                            ...
                            <div class="jcard_center_self">
                                 <?php $Job_title = $value['job']; ?>   
                                 <h5 class="heading_title"><?php echo (strlen($Job_title) > 15) ? substr($Job_title, 0, 15) . '...' : $Job_title; ?></h5>
                                 <br>
                                 <p>{{__("customer.text_contract_no")}} {{$value['contract_id']}}</p>
                                 ...
                                 <div class="jc_inbox_contract">
                                    ...
                                    <a href="{{Route('seeker.contract_details')}}?id={{$value['contract_id']}}" class="jc_inbox2 f_bold clr_prpl f12 btn add_btn">
