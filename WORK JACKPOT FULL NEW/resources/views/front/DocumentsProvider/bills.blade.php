    ...
    <div class="main_right">
        ...
        <div class="contact_tabs">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="bills-tab"  href="{{Route('provider.documents_bills')}}" aria-controls="chat" >
                        <span class="tab_icon_a">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <!-- Bills -->
                <?php if (count($get_reports_unpaid)>0) { ?>
                <div class="tab-pane fade active show" id="bills" role="tabpanel" aria-labelledby="bills-tab">
                    <div class="job_card_wrapper_contract">
                        <?php foreach ($get_reports_unpaid as $key => $value) { ?>
