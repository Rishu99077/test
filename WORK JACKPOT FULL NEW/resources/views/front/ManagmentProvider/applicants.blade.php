...
<div class="main_right">
    ...
    <div class="contact_tabs">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link active" id="applicant-tab"  href="{{Route('provider.applicants')}}">
                                ...
                                <div class="job_card">
                                    ...
                                    <div class="jcard_top d-flex align-items-center justify-content-between">
                                        <div class="jc_left d-flex align-items-center justify-content-between">
                                            ...
                                            <?php 
                                                ...
                                                $fulltitle = $value['job_title'];
                                            ?>
                                            <div class="jc_left_r">
                                                <p class="mb0 f16 clr_prpl f_black"><?php echo (strlen($fullname) > 15) ? substr($fullname, 0, 15) . '...' : $fullname; ?>(<?php echo (strlen($fulltitle) > 10) ? substr($fulltitle, 0, 10) . '...' : $fulltitle; ?>)</p>
                                    ...
                                    <div class="jcard_center">
                                        ...
                                        <div class="text-center">
                                            <button class="btn approve_btn" id="send_pending" data-id="{{$value['contract_id']}}" job-id="{{$value['job_id']}}" data-status="Published">{{__("customer.text_approve")}}</button>
                                        </div>
                                        <div class="text-center">
                                            <button class="btn reject_btn" id="send_pending" data-id="{{$value['contract_id']}}" job-id="{{$value['job_id']}}" data-status="Reject">{{__("customer.text_reject")}}</button>
                                        </div>    

                                    </div>

                                    <div class="jc_footer">
                                        <a href="{{Route('seeker_profile')}}?ID={{$value['id']}}&Page=Work Management" class="">{{__("customer.text_view_profile")}}</a>
                                    </div>
