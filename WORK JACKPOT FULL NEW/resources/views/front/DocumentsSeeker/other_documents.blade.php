    ...
    <div class="main_right">
        ...
        <div class="contact_tabs">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="other-documents-tab" href="{{Route('seeker.documents_other_documents')}}">
                           ...
                           @foreach($OtherDocuments as $key => $document)
                            <div class="job_card_contract">
                                ...
                                <div class="jcard_center_self">
                                    <?php $fulltitle = $document['title']; ?>   
                                     <h5 class="heading_title" style="height: 55px;"><?php echo (strlen($fulltitle) > 30) ? substr($fulltitle, 0, 30) . '...' : $fulltitle; ?></h5>
                                     <br>
                                     ...
                                     <div class="jc_inbox_contract">
                                        ...
                                        <a href="{{Route('seeker.contract_details')}}?id={{$document['contract_id']}}" class="jc_inbox2 f_bold clr_prpl f12 btn add_btn">
