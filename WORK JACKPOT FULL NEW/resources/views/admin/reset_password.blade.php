...
<head>
    ...
    <title>{{__("admin.text_reset_pass")}} - {{__("admin.text_work_jackpot")}}</title>
        ...
        <section class="login_sec reset_pass pass_bg sign log_sign_sec py_56 d-flex align-items-center">
            <div class="container">
                <div class="row align-items-start">
                    ...
                    <div class="col-md-6">
                        <form action="{{Route('admin_update_password')}}" autocomplete="off" class="log_frm" method="post">
                            @csrf
                            <div class="overflow_scroll">
                                <div class="loginfrm_head">
                                    <h3 class="f24 f_black">{{__("admin.text_reset_pass")}}</h3>
                                    <p class="f14">Resetting your password is easy. just type your email, and  we will send you email to reset your password </p>
                                </div>
                                <div class="form_row">
                                    <label for="pass">{{__("admin.text_new_password")}}</label>
                                    <input type="hidden" name="id" value="{{request()->id}}">
                                    <input type="password" name="new_password" placeholder='{{__("admin.text_enter")}} {{__("admin.text_new_password")}}'>
                                ...
                                <div class="form_row">
                                    <label for="confirm_password">{{__("admin.text_confirm_password")}}</label>
                                    <input type="password" name="confirm_password" id="confirm_password" placeholder='{{__("admin.text_enter")}} {{__("admin.text_confirm_password")}}'>
                                    <span class="text-danger text_center"> 
