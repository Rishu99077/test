        ...
        <div class="job_card">
            ...
            <div class="jcard_center">
                ...
                <div class="jc_inbox">
                  ...
                  <span class="jc_inbox2 f_bold clr_prpl f12" title="Experience">{{$value['experience']}}</span>
                </div>
                ...
                <div class="jc_inbox">
                  ...
                  <span class="jc_inbox2 f_bold clr_prpl f12" title="Working hours">{{$value['working_hours']}}</span>
                </div>
                ...
                <div class="jc_inbox">
                  ...
                  <span class="jc_inbox2 f_bold clr_prpl f12" title="Driving Licence">{{__("admin.text_driving_license")}}</span>
                  @elseif($value['driving_license']=='0')
                  <span class="jc_inbox2 f_bold clr_prpl f12" title="Driving Licence">-</span>
                  @endif
                </div>
                ...
                <div class="jc_inbox">
                  ...
                  <?php $full_location = $value['work_location']; ?> 
                  <span class="jc_inbox2 f_bold clr_prpl f12" title="Work location"><?php echo (strlen($full_location) > 15) ? substr($full_location, 0, 15) . '...' : $full_location; ?></span>
                </div>
            ...
            @if($value['status']=='Pending')
              <div class="jc_footer">
                  <a href="{{Route('admin_job_detail',['id'=>$value['job_id']])}}" class="d-flex align-items-center justify-content-between bg-warning"><span> {{$value['status']}}</span></a>
              </div>
            ...
            @elseif($value['status']=='Published' || $value['status']=='Ongoing')
              <div class="jc_footer">
                  <a href="{{Route('admin_job_detail',['id'=>$value['job_id']])}}" class="d-flex align-items-center justify-content-between" ><span> {{__("admin.text_total_applier")}} </span> 
