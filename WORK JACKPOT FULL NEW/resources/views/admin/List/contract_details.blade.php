        ...
        <div class="job_card job_details_sec mb_20">
            ...
            <div class="jcard_top px-0 d-flex align-items-center justify-content-between">
                <div class="jc_left d-flex align-items-center justify-content-between">
                    ...
                    <div class="jc_left_r">
                        <p class="mb0 f16 clr_prpl f_black">{{$get_other_document['doc_title']}}</p>
                        <p class="clr_grey f12 mb0 f_bold">{{__("admin.text_job_no")}} {{$get_other_document['job_id']}} <span class="clr_ylw"> {{$get_other_document['start_date']}}</span></p>
                    </div>
                </div>
            </div>
            ...
            <div class="uniq_cent flex-wrap  px-0 d-flex align-items-center justify-content-between">
	            <div class="jcard_center px-0">
	                ...
	                <div class="jc_inbox"><span class="jc_inbox1"><img src="{{ asset('admin/assets/images/j1.png') }}" alt=""></span> <span class="jc_inbox2 f_bold clr_prpl f12">{{$get_other_document['experience']}}</span></div>

	                <div class="jc_inbox"><span class="jc_inbox1"><img src="{{ asset('admin/assets/images/j2.png') }}" alt=""></span> <span class="jc_inbox2 f_bold clr_prpl f12">{{$get_other_document['working_hours']}}</span></div>

	                <div class="jc_inbox"><span class="jc_inbox1"><img src="{{ asset('admin/assets/images/j3.png') }}" alt=""></span> 
	                	<?php if ($get_other_document['driving_license']!='') { ?>
	                ...
	                <div class="jc_inbox"><span class="jc_inbox1"><img src="{{ asset('admin/assets/images/j4.png') }}" alt=""></span> 
	                	<?php if ($get_other_document['own_car']!='') { ?>
	                ...
	                <div class="jc_inbox"><span class="jc_inbox1"><img src="{{ asset('admin/assets/images/j5.png') }}" alt=""></span> <span class="jc_inbox2 f_bold clr_prpl f12">{{$get_other_document['work_location']}} </span></div>
            ...
            <div class="jc_footer px-0">
                ...
                <p class="clr_grey f_regular f_14 description_p">{{$get_other_document['description']}}<a href="#">{{__("admin.text_read_more")}}</a></p>
            </div>
