               ...
               <?php if (!empty($documents)) { 
                  ...
                  <div class="job_card_contract">
                     ...
                     <div class="jcard_center_self">
                        <?php $fullname = $value['name']; ?> 
                        <h5 class="heading_title"><?php echo (strlen($fullname) > 15) ? substr($fullname, 0, 15) . '...' : $fullname; ?>  </h5>
                        <br>
                        <p>{{__("admin.text_customer_id")}} {{$value['customer_id']}}</p>
                        ...
                        <div class="jc_inbox_contract">
                           ...
                           <a href="{{ route('customer_edit',['id'=>$value['customer_id']]) }}" class="jc_inbox2 f_bold clr_prpl f12 btn add_btn">
                           <span>{{__("admin.text_view_details")}} </span>
                           </a>
                           <?php if($value['file'] !=""){
                              $link = url('/uploads',$value['file']); ?>
