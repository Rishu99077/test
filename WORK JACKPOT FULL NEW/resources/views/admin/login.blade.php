...
<head>
    ...
    <title>{{__("admin.text_login")}} - {{__("admin.text_work_jackpot")}}</title>
        ...
        <section class="login_sec login_main_sec log_sign_sec py_56 mb_100">
            <div class="container">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-6">
                        <form action="{{url('admin/login')}}" autocomplete="off" class="log_frm" method="post">
                            @csrf    
                            <div class="overflow_scroll mh_auto">
                                <div class="loginfrm_head">
                                    <h3 class="f32">{{__("admin.text_admin_login")}}</h3>
                                ...
                                <div class="form_row mb_12">
                                    <label for="pass">{{__("admin.text_password")}}</label>
                                    <input type="password" required name="password" id="pass" placeholder='{{__("admin.text_enter")}} {{__("admin.text_password")}}'>
                                </div>
                                <div class="form_row text-end forget_password">
                                    <a href="{{Route('admin_forgotpassword')}}" class="f14 f_medium">{{__("admin.text_forgot_password")}}?</a>
                                </div>
                                <div class="submit_btn text-center">
                                    <button type="submit" class="site_btn w_auto" >{{__("admin.text_login")}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
