  ...
  <head>
	...
	<table class="em_full_wrap" valign="top" width="600px" cellspacing="0" cellpadding="0" border="0" bgcolor="#efefef" align="center">
	    <tbody>
	        ...
	        <tr>
	          <td style="padding:15px 70px 35px;font-size: 16px;" class="em_padd" valign="top" bgcolor="#f6f7f8" align="center">Please <a href="{{url('admin/reset_password')}}/<?php echo $user_id; ?>">click here</a> to reset your password </td>
	        </tr>
	        <tr>
