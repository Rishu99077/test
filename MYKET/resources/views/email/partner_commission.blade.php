            ...
            <tr>
                <td valign="top" colspan="3" style="padding:25px;">
                    ...
                    <table class="tourtastique_thanks">
                        ...
                        <tr>
                            <td style="color: #000;font-size: 16px;font-weight: 500;width: 30%;">
                                Product Total: {{ get_price_front('', '', '', '', $product_total) }}
                            </td>
                        </tr>
                        <tr>
                            <td style="color: #000;font-size: 16px;font-weight: 500;width: 30%;">
                                Partner commission Amount: {{ get_price_front('', '', '', '', $partner_total) }}
                            </td>
                        </tr>
                        <tr>
                            <td style="color: #000;font-size: 16px;font-weight: 500;width: 30%;">
                                Admin Commission Amount: {{ get_price_front('', '', '', '', $admin_total_commission) }}
                            </td>
                        </tr>
                    </table>
                                ...
                                <tbody>
                                    <tr>
                                        <td
                                            ...
                                            <p><span><b>{{ $value->product_name }}</b></span></p>
                                        </td>
                                        <td
                                            style="padding: 0px 15px;font-size: 14px;margin-top: 10px;margin-bottom: -10px;">
                                            <p><span><b>{{ $value->commission }} (%)</b></span></p>
                                        </td>
                                        <td
                                            style="padding: 0px 15px;font-size: 14px;margin-top: 10px;margin-bottom: -10px;">
                                            <p><span><b>{{ get_price_front('', '', '', '', $value->product_amount) }}</b></span>
                                            </p>
                                        </td>
                                        <td
                                            style="padding: 0px 15px;font-size: 14px;margin-top: 10px;margin-bottom: -10px;">
                                            <p><span><b>{{ get_price_front('', '', '', '', $value->admin_commission_amount) }}</b></span>
                                            </p>
                                        </td>
                                        <td
                                            style="padding: 0px 15px;font-size: 14px;margin-top: 10px;margin-bottom: -10px;">
                                            <p><span><b>{{ get_price_front('', '', '', '', $value->partner_amount) }}</b></span>
                                            </p>
                                        </td>
