                            ...
                            <tr>
                                <td valign="top" style="padding: 20px;">
                                    ...
                                    <p style="margin-top: 5px;font-size: 13px;line-height: 18px;">
                                        We send a otp to  verify  your account.
                                    </p>
                                    <p style="margin-top: 5px; font-size: 13px; line-height: 18px;">
                                        This Your Verficatio Otp. 
                                    </p>
                                    <br>
                                    <!-- <a href="{{route('reset_password',$token_)}}" style="color: #fff;background-color: #000337; text-decoration: none; padding: 15px;display: block;margin: 0 auto;font-weight: 600;font-size: 16px;text-align: center;">
                                       Get Link</a> -->
                                </td>
                            </tr>
                        </tbody>
