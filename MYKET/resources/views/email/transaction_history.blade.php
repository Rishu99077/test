                    ...
                    <table class="tourtastique_thanks">
                        ...
                        <tr>
                            <td colspan="2"
                                ...
                                Thank you for choosing mytket.com.Your Current Transaction is given below.
                            </td>
                        </tr>
                    </table>

                    <table class="tourtastique_thanks table-bodred" border="1">
                        <tbody class="trans_row">
                            <tr>
                        ...
                        <tbody class="trans_data">
                            <tr>
                                <td>
                                    <p><span><b>{{ get_price_front('', '', '', '', $total_commission) }}</b></span></p>
                                </td>
                                <td>
                                    <p><span><b>{{ get_price_front('', '', '', '', $amount_paid) }}</b></span></p>
                                </td>
                                <td>
                                    <p><span><b>{{ get_price_front('', '', '', '', $total_paid) }} </b></span></p>
                                </td>
                                <td>
                                    <p><span><b>{{ get_price_front('', '', '', '', $due) }}</b></span></p>
                                </td>
                                <td>
                                    <p><span><b>{{ $amount_type }}</b></span></p>
                                </td>
                                <td>
