                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row p-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <span>{{ $orderData['address'] }} {{ $orderData['city'] }} ,
                                                {{ $orderData['state'] }} ,
                                                {{ $orderData['country'] }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row p-3">
                                        <div class="col-md-6">
                                            ...
                                            <span class="status_pending">{!! checkStatus($orderData['status']) !!}</span>
                                        </div>
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body p-3">
                            <table class="table table_detail" id="example-2">
                                ...
                                @if (isset($orderData['order_json']))
                                    @foreach ($orderData['order_json'] as $key => $value)
                                        @php
                                            $class = '';
                                ...
                                <tbody class="checkout_body">
                                    @if (isset($orderData['cart_tax_fee']))
                                        @foreach ($orderData['cart_tax_fee'] as $key => $value_check)
                                            <tr>
