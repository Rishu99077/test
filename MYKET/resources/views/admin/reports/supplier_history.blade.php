                    ...
                    <form action="" method="post" id="">
                        ...
                        <div class="card p-20 pb-0 pt-1">
                            <div class="row">
                                ...
                                <div class="col-sm-3 form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" placeholder="Supplier Name"
                                            name="supplier_name" value="{{ $common['supplier_name'] }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2 form-group">
                                    ...
                                    <div>
                                        <select name="supplier_status" class="form-control">
                                            <option value=""></option>
                                            <option value="Active" {{ getSelected($common['supplier_status'], 'Active') }}>
                                                {{ translate('Active') }}</option>
                                            <option value="Deactive"
                                                {{ getSelected($common['supplier_status'], 'Deactive') }}>
                                                {{ translate('Deactive') }}
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-2 form-group">
                                    <label class="form-label" for="supplier_date">{{ translate('Date') }}</label>
                                    <input class="form-control datetimepicker" id="timepicker3" name="supplier_date"
                                        type="text" placeholder="Y-m-d to Y-m-d" value="{{ $common['supplier_date'] }}"
                                ...
                                <table class="table table-striped table-bordered" id="example-2">
                                    ...
                                    @if (count($get_supplier) > 0)
                                        @foreach ($get_supplier as $key => $value)
                                            <tr>
                                                <th scope="row">{{ $key + $get_supplier->firstItem() }}</th>
                                                ...
                                                <td>
                                                    <div class="action_cls mt-2">
                                                        <a href="{{ route('admin.supplier_history_details', encrypt($value['id'])) }}"
