        ...
        <div class="page-header">
            ...
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.categories') }}">{{ $common['title'] }}</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form id="main" method="post" action="{{ route('admin.categories.add') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3 {{ $errors->has('title') ? 'has-danger' : '' }}">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('title', $get_category_language['title']) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="media-left">
                                            <a href="#" class="profile-image">
                                                <img class="user-img img-circle img-css" id="image_1"
                                                    src="{{ $get_category['image'] != '' ? url('uploads/categories', $get_category['image']) : asset('uploads/placeholder/placeholder.png') }}">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3 {{ $errors->has('status') ? 'has-danger' : '' }}">
                                            ...
                                            <select id="status" name="status" class="form-control stock">
                                                ...
                                                <option value="Deactive"
                                                    {{ getSelected($get_category['status'], 'Deactive') }}>
                                                    {{ translate('Deactive') }}
                                                </option>
                                            </select>
                                            @error('status')
