                        ...
                        <div class="card-block">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="example-2">
                                    ...
                                    @if (count($Teams) > 0)
                                        @foreach ($Teams as $key => $value)
                                            <tr>
                                                <th scope="row">{{ $key + $get_teams->firstItem() }}</th>
                                                ...
                                                <td>
                                                    <div class="action_cls mt-2">
                                                        <a href="{{ route('admin.teams.edit', encrypt($value['id'])) }}"
                                                            class="btn btn-success btn-icon">
                                                            <i class="icofont icofont-ui-edit"></i></a>
                                                        <a data-href="{{ route('admin.teams.delete', encrypt($value['id'])) }}"
                                ...
                                <div class="dataTables_paginate paging_simple_numbers">
                                    {{ $get_teams->appends(request()->query())->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
