...
@section('content')
    <?php
    $data = ['banner_title', 'banner_description', 'banner_image', 'top_destination_heading'];
    $data = getPagemeta($data, $language_id, $Page->id);
    
    $top_destination_val = ['destination_image' => '', 'destination_title' => ''];
    $top_destinations = getPagemeta_multi($top_destination_val, $language_id, $Page->id, 'top_destinations');
            ...
            <form id="main" method="post" action="{{ route('admin.pages.edit', encrypt($Page->id)) }}"
                ...
                <div class="row row-header">
                    <div class="col-md-12 col-xl-12 bg-white pl-0">
                        <p class="p-10 ml-0">{{ translate('Guide') }}</p>
                ...
                <div class="row">
                    <div class="col-lg-12 col-xl-12 bg-white pl-0">
                        ...
                        <ul class="nav nav-tabs md-tabs tabs-left b-none" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link banner active" data-toggle="tab" href="#contacts"
                                    role="tab">{{ translate('Guide') }}</a>
                                <div class="slide"></div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link new_activity" data-toggle="tab" href="#top_destinations"
                                    role="tab">{{ translate('Top Destinations') }}</a>
                                <div class="slide"></div>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content tabs-left-content card-block w-100">
                            ...
                            {{-- Top Destinations --}}
                            <div class="tab-pane" id="top_destinations" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3 ">
                                            <label class="col-form-label">{{ translate('Top Destination Heading') }}<span
                                                    class="mandatory cls" style="color:red;font-size:15px">*<span></label>
                                            <input id="top_destination_heading" class="form-control top_destination_heading"
                                                name="page_content[top_destination_heading]" type="text"
                                                value="{{ $data['top_destination_heading'] }}"
                                ...
                                {{-- <div class="show_destinations">                                                   
                               <?php $dest_count = 0; ?>
                                @if (count($top_destinations) == 0)
                                    <?php $destination = $top_destination_val; ?>
                                    @include('admin.pages.page7._top_destination')
                                    <?php $dest_count++; ?>
                                @else
                            ...
                            <div class="row">
                                <div class="col-md-12 add_more_button my-4">
                                    <button type="button" class="btn btn-primary btn-sm add_destination"
                                    id="add_destination"> <span class="fa fa-plus"></span>
    ...
    {{-- <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#add_destination').click(function(e) {
                var ParamArr = {
                    'view': 'admin.pages.page7._top_destination',
                    'dest_count': count
                }
                getAppendPage(ParamArr, '.show_destinations');
                e.preventDefault();
                count++;
            });
            $(document).on('click', ".delete_destination", function(e) {
                var length = $(".top_destinations").length;
