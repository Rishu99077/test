            ...
            <form id="main" method="post" action="{{ route('admin.pages.edit', encrypt($Page->id)) }}"
                ...
                <div class="row row-header">
                    <div class="col-md-12 col-xl-12 bg-white pl-0">
                        <p class="p-10 ml-0">{{ translate('Listing') }}</p>
                ...
                <div class="row">
                    <div class="col-lg-12 col-xl-12 bg-white pl-0">
                        ...
                        <ul class="nav nav-tabs md-tabs tabs-left b-none" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link banner_details active" data-toggle="tab" href="#banner_details"
                                    role="tab">{{ translate('Banner Details') }}</a>
                                <div class="slide"></div>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content tabs-left-content card-block w-100">
                            <div class="tab-pane active" id="banner_details" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3 ">
                                            <label class="col-form-label">{{ translate('Banner Title') }}<span
                                                    class="mandatory cls" style="color:red;font-size:15px">*<span></label>
                                            <input id="listing_banner_title" class="form-control listing_banner_title"
                                                name="page_content[listing_banner_title]" type="text"
                                                value="{{ $data['listing_banner_title'] }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3 ">
                                            ...
                                            <textarea rows="2" name="page_content[listing_banner_description]" id="listing_banner_description"
                                                class="summernote listing_banner_description">{{ $data['listing_banner_description'] }}</textarea>
                                            <div class="col-form-alert-label">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div
                                            class="form-group mb-3 {{ $errors->has('listing_banner_image') ? 'has-danger' : '' }}">
                                            <label class="col-form-label">{{ translate('Banner Image') }}<span
                                                    class="mandatory cls" style="color:red; font-size:15px">*</span></label>
                                            <input type="file"
                                                class="form-control {{ $errors->has('listing_banner_image') ? 'form-control-danger' : '' }}"
                                                onchange="loadFile(event,'image_5')"
                                                name="page_content[listing_banner_image]">
                                            @error('listing_banner_image')
                                                <div class="col-form-alert-label">
                                                    {{ $message }}
                                                </div>
                                            @enderror
                                        ...
                                        <div class="media-left">
                                            <a href="#" class="profile-image">
                                                <img class="user-img img-circle img-css" id="image_5"
                                                    src="{{ $data['listing_banner_image'] != '' ? url('uploads/pages', $data['listing_banner_image']) : asset('uploads/placeholder/placeholder.png') }}">
                                            </a>
                                        </div>
                                    </div>
                                </div>
