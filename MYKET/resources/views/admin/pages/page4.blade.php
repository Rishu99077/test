...
@section('content')
    <?php
    $data = ['privacy_policy_title', 'privacy_policy_description'];
            ...
            <form id="main" method="post" action="{{ route('admin.pages.edit', encrypt($Page->id)) }}"
                ...
                <div class="row row-header">
                    <div class="col-md-12 col-xl-12 bg-white pl-0">
                        <p class="p-10 ml-0">{{ translate('Privacy Policy') }}</p>
                        ...
                        <ul class="nav nav-tabs md-tabs tabs-left b-none" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#privacy_policy"
                                    role="tab">{{ translate('Privacy Policy') }}</a>
                                <div class="slide"></div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3 ">
                                            <label class="col-form-label">{{ translate('Privacy Title') }}<span
                                                    class="mandatory cls" style="color:red;font-size:15px">*<span></label>
                                            <input id="privacy_policy_title" class="form-control privacy_policy_title"
                                                name="page_content[privacy_policy_title]" type="text"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3 ">
                                            <label
                                                class="col-form-label">{{ translate('Privacy Policy Description') }}</label>
                                            <textarea rows="2" name="page_content[privacy_policy_description]" id="privacy_policy_description"
                                                class="summernote privacy_policy_description">{{ $data['privacy_policy_description'] }}</textarea>
                                            <div class="col-form-alert-label">
                                            </div>
                                        </div>
                                    </div>
