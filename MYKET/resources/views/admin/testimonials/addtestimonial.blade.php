                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form id="main" method="post" action="{{ route('admin.testimonials.add') }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <input type="hidden" name="id" value="{{ $get_testimonial['id'] }}">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3 {{ $errors->has('title') ? 'has-danger' : '' }}">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('title', $get_testimonial_language['title']) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3 {{ $errors->has('image') ? 'has-danger' : '' }}">
                                            <label class="col-form-label">{{ translate('Image') }}<span
                                                    class="mandatory cls" style="color:red; font-size:15px">*</span></label>
                                            <input type="file"
                                        ...
                                        <div class="media-left">
                                            <a href="#" class="profile-image">
                                                <img class="user-img img-circle img-css" id="image"
                                                    src="{{ $get_testimonial['image'] != '' ? url('uploads/testimonials', $get_testimonial['image']) : asset('uploads/placeholder/placeholder.png') }}">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control summernote" name="description" type="message" placeholder="Enter Description">{{ old('description', $get_testimonial_language['description']) }}</textarea>

                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3 {{ $errors->has('destination') ? 'has-danger' : '' }}">
                                            <label class="col-form-label">{{ translate('Destination') }}<span
                                                    class="mandatory cls" style="color:red; font-size:15px">*</span></label>
                                            <input
                                                class="form-control {{ $errors->has('destination') ? 'form-control-danger' : '' }}"
                                                name="destination" type="text"
                                                value="{{ old('destination', $get_testimonial_language['destination']) }}"
                                        ...
                                        <div class="form-group mb-3 {{ $errors->has('status') ? 'has-danger' : '' }}">
                                            ...
                                            <select id="status" name="status" class="form-control stock">
                                                ...
                                                <option value="Deactive"
                                                    {{ getSelected($get_testimonial['status'], 'Deactive') }}>
                                                    {{ translate('Deactive') }}
                                                </option>
                                            </select>
                                            @error('status')
