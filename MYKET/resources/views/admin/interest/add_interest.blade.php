                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form id="main" method="post" action="{{ route('admin.interests.add') }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <input type="hidden" name="id" value="{{ $get_interest['id'] }}">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3 {{ $errors->has('title') ? 'has-danger' : '' }}">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('title', $get_interest_language['title']) }}"
                                        ...
                                        <div class="form-group mb-3 {{ $errors->has('status') ? 'has-danger' : '' }}">
                                            ...
                                            <select id="status" name="status" class="form-control stock">
                                                ...
                                                <option value="Deactive"
                                                    {{ getSelected($get_interest['status'], 'Deactive') }}>
                                                    {{ translate('Deactive') }}
                                                </option>
                                            </select>
                                            @error('status')
