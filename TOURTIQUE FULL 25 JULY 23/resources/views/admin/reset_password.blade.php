                            ...
                            <div class="row g-0 h-100">
                                ...
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <div class="row flex-between-center mt-4">
                                            <div class="col-auto">
                                        ...
                                        <form class="row g-3 needs-validation" method="post"
                                            action="{{ route('update_password') }}" novalidate="">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input
                                                    ...
                                                    required="" id="card-email" type="password" />
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between">
                                                    <label class="form-label" for="card-password">Confirm
                                                        Password</label>
                                                </div><input
                                                    class="form-control {{ $errors->has('confirm_password') ? 'is-invalid' : '' }}"
                                                    name="confirm_password" id="card-password"
                                                    value="{{ old('confirm_password') }}" type="password" />
                                                <div class="invalid-feedback">
