...
<div class="row expe_div">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input class="form-control {{ $errors->has('exp_title.' . $lang_id) ? 'is-invalid' : '' }}" placeholder="{{ translate('Enter Title') }}" id="exp_title" name="exp_title[{{ $lang_id }}][]" type="text" value="{{ getLanguageTranslate($get_product_experience_icon_language, $lang_id, $PEI['id'], 'title', 'experience_icon_id') }}" />
        @error('exp_title.' . $lang_id)
