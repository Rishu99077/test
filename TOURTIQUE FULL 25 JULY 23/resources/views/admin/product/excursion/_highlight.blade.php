...
<div class="row highlight_div">
    ...
    <div class="col-md-6 mb-3 row_highLight_div">
        <div class="w-100">
        <label class="form-label" for="title">{{ translate('Higlights Title') }}<span class="text-danger">*</span>
        </label>
    ...
    <div class="col-md-6">
        ...
        <div class="w-100">
            ...
            <textarea
                class="form-control index_high_desc Langauge_{{ $lang_id }} footer_text footer_text_{{ $data }} {{ $errors->has('highlights_description.' . $lang_id) ? 'is-invalid' : '' }}"
                placeholder="{{ translate('Enter Higlights Description') }}" id="highlights_description_{{ $lang_id }}_{{ $data }}" 
