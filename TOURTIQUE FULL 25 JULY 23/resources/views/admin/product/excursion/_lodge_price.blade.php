...
<tr class="lodge_price_row">
    ...
    <td>
        <input class="form-control datetimepicker {{ $errors->has('lodge_price_from_date') ? 'is-invalid' : '' }}"
    ...
    <td>
        <input class="form-control datetimepicker {{ $errors->has('lodge_price_to_date') ? 'is-invalid' : '' }}"
