...
<div class="row voucher_div">
        ...
        <div class="col-lg-3 mt-2">
            <div class="avatar shadow-sm img-thumbnail position-relative blog-image-cls">
                <div class="h-100 w-50  overflow-hidden position-relative">
                    <img src="{{ $GPV['voucher_image'] != '' ? asset('uploads/product_images/' . $GPV['voucher_image']) : asset('uploads/placeholder/placeholder.png') }}" id="upload_voucher_logo_<?php echo $data; ?>" width="50%" alt="" />
                </div>
            </div>
        </div>
    </div>  
    ...
    <div class="col-md-6 content_title">
        ...
        <div class="col-lg-3 mt-2">
            <div class="avatar shadow-sm img-thumbnail position-relative blog-image-cls">
                <div class="h-100 w-50  overflow-hidden position-relative">
                    <img src="{{ $GPV['client_logo'] != '' ? asset('uploads/product_images/' . $GPV['client_logo']) : asset('uploads/placeholder/placeholder.png') }}" id="upload_client_logo_<?php echo $data; ?>" width="50%" alt="" />
                </div>
            </div>
        </div>
    </div>   
    ...
    <div class="col-md-6 content_title">
        ...
        <div class="col-lg-3 mt-2">
            <div class="avatar shadow-sm img-thumbnail position-relative blog-image-cls">
                <div class="h-100 w-50  overflow-hidden position-relative">
                    <img src="{{ $GPV['our_logo'] != '' ? asset('uploads/product_images/' . $GPV['our_logo']) : asset('uploads/placeholder/placeholder.png') }}" id="upload_our_logo_<?php echo $data; ?>" width="50%" alt="" />
                </div>
            </div>
        </div>
    </div>   
