                                    ...
                                    <div class="swiper-container theme-slider h-100"
                                        ...
                                        <div class="swiper-wrapper h-100">
                                            ...
                                            <div class="swiper-slide h-100"><a class="d-block h-sm-100"
                                                    href="{{ route('admin.excursion.edit', encrypt($value['id'])) }}"><img
                                    ...
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0">
                                            <a class="text-dark fs-0 fs-lg-1"
                                                href="{{ route('admin.excursion.edit', encrypt($value['id'])) }}">
                                                @php
                                        ...
                                        <p class="fs--1 mb-2 mb-md-3"><a class="text-500" href="#!">
                                                @php
                                                    ...
                                                    foreach ($catArr as $Ckey => $Cvalue) {
                                                        ...
                                                        $newCategory .= getAllInfo('category_language', ['category_id' => $Cvalue, 'language_id' => 3], 'description') . $coma;
                                                    }
                                        ...
                                        <ul class="list-unstyled d-none d-lg-block mb-0">
                                            ...
                                            <?php {
                                                ...
                                                foreach ($get_supplier_arr as $key => $value2) {
                                                    ...
                                                    ->first(); ?>
                                            @if ($get_supplier)
                                                <li><span>{{ $get_supplier['username'] }},<b>{{ $get_supplier['company_name'] }}</b></span>
                                                </li>
                                            @endif
                                            <?php } } ?>
                                        </ul>
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between flex-column">
                                        ...
                                        <div class="d-flex justify-content-evenly ">
                                            <a class="btn btn-sm btn-outline-secondary border-300 d-lg-block me-2 me-lg-0"
                                                ...
                                                <span
                                                    class="ms-2 d-none d-md-inline-block">{{ translate('Edit') }}</span></a>
                                            <a class="btn btn-sm btn-primary d-lg-block confirm-delete"
                                                data-href="{{ route('admin.excursion.delete', encrypt($value['id'])) }}"
                                        ...
                                        <a class="btn btn-outline-success me-1 mb-1 btn-sm confirm-duplicate d-lg-block m-2 mt-1"
                                            data-href="{{ route('admin.excursion.duplicate', encrypt($value['id'])) }}"
