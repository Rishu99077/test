...
<tr class="row_group_percentage">
    ...
    <td>
        <input class="form-control numberonly {{ $errors->has('tour_upgrade_price_adult') ? 'is-invalid' : '' }}"
            ...
            placeholder="{{ translate('Default Price') }} " value="{{ $GPOGP['default_percentage'] }}" />
    ...
    <td>
        ...
        <input class="form-check-input mt-2 tour_group_percentage_allowed" id="flexCheckDefault" id="option_status"
    ...
    <td>
        ...
        <input class="form-control numberonly {{ $errors->has('tour_upgrade_price_child') ? 'is-invalid' : '' }}"
            ...
            placeholder="{{ translate('WeekDays Price') }}"
    ...
    <td>
        <input class="form-control numberonly {{ $errors->has('tour_upgrade_price_infant') ? 'is-invalid' : '' }}"
            ...
            placeholder="{{ translate('Period Price') }} "
            @php if($GPOGP['period_set_default'] != 1 && !isset($append)&& $get_product['id'] != "" )
