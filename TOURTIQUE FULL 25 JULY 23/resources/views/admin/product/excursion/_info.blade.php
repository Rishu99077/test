...
<div class="row info_div">
    ...
    <div class="col-md-6">
        <label class="form-label" for="title">{{ translate('Additional Info Title') }}<span class="text-danger">*</span>
        </label>
        <input class="form-control index_info_title Langauge_{{ $lang_id }} {{ $errors->has('info_title.' . $lang_id) ? 'is-invalid' : '' }}"
