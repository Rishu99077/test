...
<div class="row  adver_div">
    ...
    <input type="hidden" name="adver_id[]" value="{{ $GPSD['id'] }}">
        ...
        <div class="col-md-6 mb-3">
            <label class="form-label" for="adver_title">{{ translate('Advertisement Title') }}<span
            ...
            <label class="form-label" for="adver_desc">{{ translate('Advertisement Description') }}<span
                                                class="text-danger">*</span>
            </label>
    ...
    <div class="col-md-6">
        ...
        <input class="form-control" id="adver_link" name="adver_link[]"
            value="{{ old('adver_link.*', $GPSD['link']) }}" type="text"/>
