                                    ...
                                    <div class="swiper-container theme-slider h-100"
                                        ...
                                        <div class="swiper-wrapper h-100">
                                            ...
                                            <div class="swiper-slide h-100"><a class="d-block h-sm-100"
                                                    href="{{ route('admin.limousine.edit', encrypt($value['id'])) }}"><img
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <h5 class="mt-3 mt-sm-0">
                                            <a class="text-dark fs-0 fs-lg-1" href="{{ route('admin.limousine.edit', encrypt($value['id'])) }}">
                                                @php
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-between flex-column">
                                        ...
                                        <div class="d-flex justify-content-evenly ">
                                            <a class="btn btn-sm btn-outline-secondary border-300 d-lg-block me-2 me-lg-0"
                                                href="{{ route('admin.limousine.edit', encrypt($value['id'])) }}">
                                            ...
                                            <a class="btn btn-sm btn-primary d-lg-block confirm-delete"
                                                data-href="{{ route('admin.limousine.delete', encrypt($value['id'])) }}"
                                        ...
                                        data-href="{{ route('admin.limousine.duplicate', encrypt($value['id'])) }}"
