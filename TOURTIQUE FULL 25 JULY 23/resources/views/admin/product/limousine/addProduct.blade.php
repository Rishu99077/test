...
<form method="post" id="add_product" enctype="multipart/form-data" action="">
    ...
    <a class="btn btn-primary me-1 mb-1 backButton float-end" target="_blank" href="{{ env('APP_URL') }}limousine-detail/{{ $get_product['slug'] }}" id="add_product_btn" type="submit"><span class="fas fa-globe"></span>
    ...
    <div class="add_product add_product-effect-scale add_product-theme-1">
        ...
        <label for="tab15" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ translate('Request Pop-up') }}"><i class="icon-group"></i></label>

        <input type="radio" name="add_product" id="tab16" class="tab-content-16 addProTab">
        <label for="tab16" data-bs-toggle="tooltip" data-bs-placement="right" title="{{ translate('Related Cars') }}"><i class="icon-car"></i></label>
    ...
    <li class="tab-content tab-content-first typography">
       <div class="row">
          ...
          <div class="col-lg-8  col-md-8 colcss">
             <div class="row">
                <div class="col-md-6">
                   <label class="form-label" for="title">{{ translate('Limousine Title') }}<span class="text-danger">*</span>
                   </label>
                ...
                <div class="col-md-6">
                   ...
                   <input class="form-control {{ $errors->has('description_title.' . $lang_id) ? 'is-invalid' : '' }}" placeholder="{{ translate('Title') }}" id="description_title_{{ $lang_id }}" name="description_title[{{ $lang_id }}]" type="text" value="{{ old('description_title.' . $lang_id, getLanguageTranslate($meta_global_language_description, $lang_id, 'limousine_description_title', 'title', 'meta_title')) }}" />
                   <div class="invalid-feedback">
                   </div>
                </div>
                <div class="col-md-12">
                   <label class="form-label" for="price">{{ translate('Limousine Description') }}
                   </label>
                ...
                <div class="col-md-6 content_title">
                   <label class="form-label" for="title">{{ translate('Limousine Location') }}
                   </label>
                   <select class="form-select single-select boat_location  {{ $errors->has('boat_location') ? 'is-invalid' : '' }}" name="boat_location" id="boat_location">
                      <option value="">{{ translate('Select Limousine Location') }}</option>
                      @foreach ($get_limousine_locations as $val)
                ...
                <div class="col-md-6 content_title">
                   <label class="form-label" for="title">{{ translate('Limousine Type') }}
                   </label>
                   <select class="form-select limit_5 single_select  {{ $errors->has('boat_type') ? 'is-invalid' : '' }}" name="boat_type[]" id="boat_type" multiple>
                      <option value="" disabled>{{ translate('Select Limousine Type') }}</option>
                      @foreach ($get_limousine_types as $val)
                ...
                <div class="col-md-6 content_title">
                   <label class="form-label" for="title">{{ translate('Car Maximum Capacity') }}
                   </label>
                   <input class="form-control numberonly {{ $errors->has('boat_maximum_capacity') ? 'is-invalid' : '' }}" id="boat_maximum_capacity" name="boat_maximum_capacity" type="text" value="{{ $get_product['boat_maximum_capacity'] }}" placeholder="{{ translate('Enter Car Maximum Capacity') }}" />
                   <div class="invalid-feedback">
                   </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="add_info_row">
                   ...
                   @include('admin.product.limousine._info')
                   @php
                   $data++;
                   $Info_data++;
                   @endphp
             ...
             <div class="row">
                <div class="col-md-12 content_title">
                   <div class="form-check form-switch pl-0">
                      ...
                      <label class="form-check-label form-label" for="excertion_status">{{ translate('Limousine Status') }}
                      </label>
                   </div>
                </div>
                <div class="col-md-12 content_title">
                ...
                <div class="col-md-12 content_title pro_status">
                   <label class="form-label" for="price">{{ translate('Limousine Type') }}</label>
                   <div class="input-group mb-3">
                      <input class="form-control" type="text" name="limousine_type" placeholder="{{ translate('Limousine Type') }}" value="{{ old('limousine_type', $get_product['excursion_type']) }}" aria-describedby="basic-addon2" id="limousine_type" />
                      <div class="invalid-feedback">
                      </div>
                   </div>
                </div>
                ...
                @endif
                <div class="col-md-12 content_title pro_status">
                   <label class="form-label" for="price">{{ translate('Limousine Information') }}
                   </label>
                   <div class="input-group mb-3">
                      <textarea class="form-control" type="text" name="product_info[limousine_type]" placeholder="{{ translate('Limousine Information') }}" aria-describedby="basic-addon2" id="limousine_type">{{ old('product_info.limousine_type', getAllInfo('product_info', ['title' => 'limousine_type', 'product_id' => $get_product['id']], 'value')) }}
                            </textarea>
                      <div class="invalid-feedback">
                      </div>
                   </div>
                ...
                <div class="col-md-12 content_title mt-3">
                   <div class="form-check form-switch pl-0">
                      <input class="form-check-input float-end " name="product_setting[add_to_recom_tours]" id="recom_tours" type="checkbox" {{ getChecked('on', old('product_setting.add_to_recom_tours', getProductSetting('limousine', $get_product['id'], 'add_to_recom_tours'))) }}>
                ...
                <div class="col-md-12 content_title mt-3">
                   <div class="form-check form-switch pl-0">
                      <input class="form-check-input float-end " name="product_setting[recom_tours_main_page_big_picture]" id="recom_tours_main_page_big_picture" type="checkbox" {{ getChecked('on', old('product_setting.recom_tours_main_page_big_picture', getProductSetting('limousine', $get_product['id'], 'recom_tours_main_page_big_picture'))) }}>
                ...
                <div class="col-md-12 content_title {{ getProductSetting('limousine', $get_product['id'], 'recom_tours_main_page_big_picture') != 'on' ? 'd-none' : '' }}" id="recom_big_div">
                ...
                <div class="col-md-12 content_title mt-3">
                   <div class="form-check form-switch pl-0">
                      <input class="form-check-input float-end " name="product_setting[recom_tours_main_page_small_picture]" id="recom_tours_main_page_small_picture" type="checkbox" {{ getChecked('on', old('product_setting.recom_tours_main_page_small_picture', getProductSetting('limousine', $get_product['id'], 'recom_tours_main_page_small_picture'))) }}>
                ...
                <div class="col-md-12 content_title mt-3">
                   <div class="form-check form-switch pl-0">
                      <input class="form-check-input float-end " name="product_setting[add_to_world_adventure_main_page]" id="add_to_world_adventure_main_page" type="checkbox" {{ getChecked('on', old('product_setting.add_to_world_adventure_main_page', getProductSetting('limousine', $get_product['id'], 'add_to_world_adventure_main_page'))) }}>
                ...
                <div class="col-md-12 content_title mt-3">
                   <div class="form-check form-switch pl-0">
                      <input class="form-check-input float-end " name="product_setting[add_to_luxury_main_page]" id="add_to_luxury_main_page" type="checkbox" {{ getChecked('on', old('product_setting.add_to_luxury_main_page', getProductSetting('limousine', $get_product['id'], 'add_to_luxury_main_page'))) }}>
                ...
                <div class="col-md-12 content_title mt-3">
                   <div class="form-check form-switch pl-0">
                      <input class="form-check-input float-end " name="product_setting[add_to_top_seller_in_uae]" id="add_to_top_seller_in_uae" type="checkbox" {{ getChecked('on', old('product_setting.add_to_top_seller_in_uae', getProductSetting('limousine', $get_product['id'], 'add_to_top_seller_in_uae'))) }}>
                ...
                <div class="col-md-12 content_title mt-3">
                   <div class="form-check form-switch pl-0">
                      <input class="form-check-input float-end " name="product_setting[related_top_rated_activity]" id="related_top_rated_activity" type="checkbox" {{ getChecked('on', old('product_setting.city_best_selling_tour', getProductSetting('limousine', $get_product['id'], 'related_top_rated_activity'))) }}>
                ...
                <div class="col-md-12 content_title mt-3 top_seller_sort_div _18xMp
                   @php if (getChecked('on',old('product_setting.add_to_top_seller_in_uae',getProductSetting('limousine', $get_product['id'], 'add_to_top_seller_in_uae'))) != ' checked')  { echo ' d-none ' ;} @endphp">
                   ...
                   <div class="form-check form-switch pl-0">
                      ...
                      @for ($i = 1; $i <= 10; $i++) <option value="{{ $i }}" {{ getSelected($i, old('product_setting.top_seller_in_uae_sort_no', getProductSetting('limousine', $get_product['id'], 'top_seller_in_uae_sort_no'))) }}>
                      {{ $i }}
                      </option>
                      @endfor
                      </select>
                ...
                <div class="col-md-12">
                   <button class="btn btn-sm btn-success mb-2 add_week_days_general_price week_days_btn" data-val="1" type="button"> <span class="fa fa-plus"></span>
                   ...
                   <div class="show_week_days_price_div">
                      ...
                      @include('admin.product.limousine._general_week_tour')
                      @php
                      $generalWeek++;
                      $id++;
                      @endphp
    ...
    <li class="tab-content tab-content-19 typography " style="display: none">
        <div class="colcss">
            <div class="row">
                ...
                <div class="col-md-6">
                    <label class="form-label" for="experience_heading">{{ translate('Experience Icon heading') }}<span class="text-danger">*</span> </label>
                    <input class="form-control {{ $errors->has('experience_heading.' . $lang_id) ? 'is-invalid' : '' }}" placeholder="{{ translate('Experience Icon heading') }}" id="experience_heading_{{ $lang_id }}" name="experience_heading[{{ $lang_id }}]" type="text" value="{{ old('experience_heading.' . $lang_id, getLanguageTranslate($get_product_language, $lang_id, $get_product['id'], 'experience_heading', 'product_id')) }}" />
            ...
            @foreach ($get_product_experience_icon as $PEI)
                @include('admin.product.limousine._experience_icon')
                @php
                    $data++;
                    $Icon_data++;
                @endphp
    ...
    <li class="tab-content tab-content-2 typography " style="display: none">
        <div class="colcss mb-1 row">
            <div class="col-md-6">
                <div class="yatch_highlight_feature">
                    ...
                    @foreach ($get_yatch_fetaure_highlight as $GYFH)
                       @include('admin.product.limousine._feature_highlight')
                       @php
            ...
            <div class="col-md-6">
                <div class="yatch_highlight_feature">
                    <h5 class="text-black mt-2 fw-semi-bold fs-0">{{ translate('Car Specifications') }}</h5>
                    <div class="row">
                        
                        <div class="col-md-6">
                            <label class="form-label" for="title">{{ translate('Car Specifications Text') }}
                            </label>
                            <input class="form-control {{ $errors->has('title.' . $lang_id) ? 'is-invalid' : '' }}" placeholder="{{ translate('Title') }}" id="title_{{ $lang_id }}" name="limousine_boat_specification_title[{{ $lang_id }}]" type="text" value="{{ old('title.' . $lang_id, getLanguageTranslate($get_yatch_boat_specification_heading, $lang_id, $get_product['id'], 'title', 'product_id')) }}" />
                            <div class="invalid-feedback">
                            </div>
                            ...
                            <textarea class="form-control {{ $errors->has('description.' . $lang_id) ? 'is-invalid' : '' }}" placeholder="{{ translate('Enter Description') }}" id="limousine_boat_specification_description" name="limousine_boat_specification_description[{{ $lang_id }}]">{{ getLanguageTranslate($get_yatch_boat_specification_heading, $lang_id, $get_product['id'], 'content', 'product_id') }}</textarea>
                            @error('limousine_boat_specification_description.' . $lang_id)
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                            @enderror
                    ...
                    <h5 class="text-black mt-2 fw-semi-bold fs-0">{{ translate('Car Specifications Key') }}
                    </h5>
                    @php
                    ...
                    @include('admin.product.limousine._boat_specification')
                    @php
        ...
        <div class="colcss">
            ...
            @include('admin.product.limousine._highlight')
            @php
            $data++;
            $High_data++;
            @endphp
    ...
    <li class="tab-content tab-content-4 typography" style="display: none">
        ...
        <div class="col-md-12 content_title colcss">
            ...
            @include('admin.product.limousine._option')
            @php
            $optiondata++;
            $data = $optiondata;
            ...
            <div class="row mt-3">
                <div class="col-md-12 add_more_button">
                    <button class="btn btn-success btn-sm float-end" type="button" id="add_table" title='Add more'>
    ...
    <li class="tab-content tab-content-6    typography" style="display: none">
        <div class="colcss">
            ...
            @include('admin.product.limousine._faq')
            @php
            $data++;
            $Faq_data++;
            @endphp
    ...
    <li class="tab-content tab-content-7    typography" style="display: none">
        <div class="colcss">
            ...
            @include('admin.product.limousine._site_advertisement')
            @php
            $data++;
            $Site_data++;
            @endphp
    ...
    <li class="tab-content tab-content-9 typography " style="display: none">
        <div class="colcss">
            ...
            @include('admin.product.limousine._voucher')
            @php
            $data++;
            $Voucher_data++;
            @endphp
    ...
    {{-- Customer Group Discount Tab Start --}}
    <li class="tab-content tab-content-10    typography" style="display: none">
        <div class="colcss">

            @foreach ($customerGroup as $key => $CG)
            @php
            $productCustomerGroup = (array) getDataFromDB('product_customer_group_discount', ['product_id' => $get_product['id'], 'customer_group_id' => $CG['id'], 'type' => 'limousine'], 'row');
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-4 content_title box">
                    <label class="form-label" for="price">{{ translate('Transfer Option % Discount') }}
    ...
    {{-- Customer Group Discount Tab End --}}
        ...
        <div class="colcss">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('header_experience_heading.' . $lang_id) ? 'is-invalid' : '' }}" id="header_experience_heading_{{ $lang_id }}" name="header_experience_heading[{{ $lang_id }}]" placeholder="{{ translate('Experience Icon heading') }}" type="text" value="{{ getLanguageTranslate($experience_icon_upper_heading, $lang_id, 'heading_title', 'title', 'meta_title') }}">
                    <div class="invalid-feedback">
                    </div>
                </div>
            ...
            @foreach ($get_product_experience_icon_upper as $PEIH)
               @include('admin.product.limousine._experience_icon_header')
               @php
                  $data++;
                  $Header_data++;
               @endphp
                ...
                <div class="yatch_highlight_feature">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control {{ $errors->has('title.' . $lang_id) ? 'is-invalid' : '' }}" placeholder="{{ translate('Title') }}" id="title_{{ $lang_id }}" name="yatch_amenities_heading[{{ $lang_id }}]" type="text" value="{{ old('title.' . $lang_id, getLanguageTranslate($get_yatch_amenities_heading, $lang_id, $get_product['id'], 'title', 'product_id')) }}" />
                            <div class="invalid-feedback">
                     ...
                     @foreach ($get_yatch_amenities as $_GYAL)
                        @include('admin.product.limousine.amenities_append._amenities_form')
                        @php
                           $amenitie_data++;
                           $data++;
                        @endphp
    ...
    <li class="tab-content tab-content-14 typography " style="display: none">
        <div class="colcss mb-1 row">
            ...
            <div class="colcss">
                ...
                @include('admin.product.limousine._transfer_option')
                @php
                $data++;
                $Transfer_data++;
                @endphp
    ...
    <li class="tab-content tab-content-16 typography" style="display: none">
        <div class="colcss">
            ...
            @foreach ($get_product_related_boats as $GYRB)
               @include('admin.product.limousine._realated_boats')
               @php
                  $data++;
               @endphp
            @endforeach
    ...
    <li class="tab-content tab-content-15    typography" style="display: none">
        <div class="colcss">
            ...
            @foreach ($get_product_request_popup as $POPUP)
               @include('admin.product.limousine._request_popup')
               @php
                  $data++;
                  $Popup_data++;
               @endphp
        ...
        <div class="colcss">
            <div class="row">
               ...
               <div class="col-md-6">
                    ...
                    <input
                        class="form-control {{ $errors->has('pro_popup_link.' . $lang_id) ? 'is-invalid' : '' }}"
                        placeholder="{{ translate('Product Pop Up Video Link') }}" id="pro_popup_link"
                        name="pro_popup_link" type="text"
...
<script type="text/javascript">
    $(document).ready(function() {
        var count = "{{ $Popup_data }}";
        $('#add_popup').click(function(e) {

            var ParamArr = {
                'view': 'admin.product.limousine._request_popup',
                'data': count
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add_highlights').click(function(e) {
            var ParamArr = {
                'view': 'admin.product.limousine._highlight',
                'data': count
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add_expe').click(function(e) {
            var ParamArr = {
                'view': 'admin.product.limousine._experience_icon',
                'data': count
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        var count = "{{ $Header_data }}";

        $('#add_expe_header').click(function(e) {
            var ParamArr = {
                'view': 'admin.product.limousine._experience_icon_header',
                'data': count
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add_boats').click(function(e) {
            var ParamArr = {
                'view': 'admin.product.limousine._realated_boats',
                'data': count
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add_yacht_highlights_key').click(function(e) {
            var ParamArr = {
                'view': 'admin.product.limousine._feature_highlight',
                'data': count
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add_voucher').click(function(e) {
            var ParamArr = {
                'view': 'admin.product.limousine._voucher',
                'data': count
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add_yacht_amenities').click(function(e) {
            var ParamArr = {
                'view': 'admin.product.limousine._boat_specification',
                'data': count
            }
        ...
        $(document).on('click', ".delete_amenities", function(e) {
            var length = $(".delete_amenities").length;
            if (length > 1) {
                deleteMsg('Are you sure to delete ?').then((result) => {
                    if (result.isConfirmed) {
...
<script>
    $(document).ready(function() {
        ...
        $('#add_amenties_').click(function(e) {
            ...
            data.count = _count;
            var ParamArr = {
                'view': 'admin.product.limousine.amenities_append._amenities_form',
                'data': _count,
                'type': "",
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#add_table').click(function(e) {
            ...
            // $("#count").val(count)
            var ParamArr = {
                'view': 'admin.product.limousine._option',
                'data': count
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('body').on('click', "#add_info", function(e) {
            ...
            var ParamArr = {
                'view': 'admin.product.limousine._info',
                'data': count
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add_faqs').click(function(e) {
            ...
            var ParamArr = {
                'view': 'admin.product.limousine._faq',
                'data': count
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add_transfer_option').click(function(e) {
            ...
            var ParamArr = {
                'view': 'admin.product.limousine._transfer_option',
                'data': count
            }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add_adver').click(function(e) {
            ...
            var ParamArr = {
                'view': 'admin.product.limousine._site_advertisement',
                'data': count
            }
...
<script>
    ...
    $(document).on("click", ".add_tour_upgrade", function(e) {
        ...
        var ParamArr = {
            'view': 'admin.product.limousine._tour_upgrade',
            'data': DataID,
        }
...
<script>
    ...
    $(document).on("click", ".add_period_pricing", function(e) {
        ...
        var DataID = $(this).data('val');
        var ParamArr = {
            'view': 'admin.product.limousine._tour_period_pricing',
            'data': DataID,
        }
...
<script>
    ...
    $(document).on("click", ".add_group_percent", function(e) {
        ...
        var DataID = $(this).data('val');
        var ParamArr = {
            'view': 'admin.product.limousine._group_percentage',
            'data': DataID,
        }
...
<script>
    ...
    $(document).on("click", ".add_week_days_price", function(e) {
        ...
        var ParamArr = {
            'view': 'admin.product.limousine._tour_price',
            'data': DataID,
            'id': tourCount
        }
...
<script>
    $(document).on("click", '.add_tour_avail_date', function() {
        ...
        var ParamArr = {
            'view': 'admin.product.limousine._tour_date_time',
            'data': dataArr,
        }
...
<script>
    $(document).on("click", ".add_lodge_price", function() {
        ...
        var ParamArr = {
            'view': 'admin.product.limousine._lodge_price',
            'data': count,
        }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add_tooltip').click(function(e) {
            var ParamArr = {
                'view': 'admin.product.limousine._tooltip',
                'data': count
            }
