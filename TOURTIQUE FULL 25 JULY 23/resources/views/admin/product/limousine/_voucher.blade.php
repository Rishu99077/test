...
<div class="row voucher_div">
    ...
    <div class="col-md-6 mb-3">
        <label class="form-label" for="title">{{ translate('Title') }}</label><span class="text-danger">*</span>
    ...
    <div class="col-md-6">
        <label class="form-label" for="description">{{ translate('Text') }}</label><span class="text-danger">*</span>
    ...
    <div class="col-md-6 content_title">
        ...
        <div class="input-group mb-3">
            <input class="form-control " type="file" name="voucher_image[]" aria-describedby="basic-addon2" onchange="loadFile(event,'upload_voucher_logo_{{$data}}{{$GPV['id']}}')" id="voucher_image"/>
        ...
        <div class="col-lg-3 mt-2">
            <div class="avatar shadow-sm img-thumbnail position-relative blog-image-cls">
                <div class="h-100 w-50  overflow-hidden position-relative">
                    <img src="{{ $GPV['voucher_image'] != '' ? asset('uploads/product_images/' . $GPV['voucher_image']) : asset('uploads/placeholder/placeholder.png') }}" id="upload_voucher_logo_{{$data}}{{$GPV['id']}}" width="50%" alt="" />
                </div>
            </div>
        </div>
    </div>  
    ...
    <div class="col-md-6 content_title">
        ...
        <div class="input-group mb-3">
            <input class="form-control " type="file" name="our_logo[]" aria-describedby="basic-addon2" onchange="loadFile(event,'upload_our_logo_{{$data}}{{$GPV['id']}}')" id="our_logo"/>
        ...
        <div class="col-lg-3 mt-2">
            <div class="avatar shadow-sm img-thumbnail position-relative blog-image-cls">
                <div class="h-100 w-50  overflow-hidden position-relative">
                    <img src="{{ $GPV['our_logo'] != '' ? asset('uploads/product_images/' . $GPV['our_logo']) : asset('uploads/placeholder/placeholder.png') }}" id="upload_our_logo_{{$data}}{{$GPV['id']}}" width="50%" alt="" />
                </div>
            </div>
        </div>
    </div>   
