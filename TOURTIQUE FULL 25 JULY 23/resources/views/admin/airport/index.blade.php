...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="col-auto ms-auto">
            <a class="btn btn-falcon-primary me-1 mb-1 mt-1" href="{{ route('admin.airport.add') }}" type="button"><span
                ...
                <div class="card-body pt-0">
                    <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                            ...
                            <div class="table-responsive scrollbar">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
                                            <th scope="col">{{ translate('Airport Name & Address') }}</th>
                                    ...
                                    <tbody>
                                        <?php $i = 1; ?>
                                        @if (!$get_airport->isEmpty())
                                            @foreach ($get_airport as $key => $value)
                                                <tr>
                                                    <td>{{ $key + $get_airport->firstItem() }}</td>
                                                    <td>{{ $value['name'] }}</td>
                                                    <td>
                                                    ...
                                                    <td class="text-end">
                                                        <div>
                                                            <a class="btn p-0"
                                                                href="{{ route('admin.airport.edit', encrypt($value['id'])) }}"
                                                            ...
                                                            <a class="btn p-0" onclick="return doconfirm();"
                                                                href="{{ route('admin.airport.delete', encrypt($value['id'])) }}"
                                                                type="button" data-bs-toggle="tooltip"
                            ...
                            <div>
                                {{ $get_airport->appends(request()->query())->links() }}
                            </div>
                        </div>
                    </div>
                </div>
