...
@section('content')
    ...
    <div class="d-flex justify-content-between">
       ...
       <!--  <div class="col-auto ms-auto">
            <a class="btn btn-falcon-primary me-1 mb-1 mt-1" href="{{ route('admin.partners.add') }}" type="button"><span
                        ...
                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                            ...
                            <div class="table-responsive scrollbar">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php $i = 1; ?>
                                        @if (!$get_partner->isEmpty())
                                            @foreach ($get_partner as $key => $value)
                                                <tr>
                                                    <td>{{ $key + $get_partner->firstItem() }}</td>
                                                    <td>{{ $value['title'] }}</td>
                                                    <td>
                                                    ...
                                                    <td class="text-end">
                                                        <div>
                                                            <a class="btn p-0"
                                                                href="{{ route('admin.partners.edit', encrypt($value['id'])) }}"
                                                          ...
                                                          <!--   <a class="btn p-0" onclick="return doconfirm();"
                                                                href="{{ route('admin.partners.delete', encrypt($value['id'])) }}"
                                                                type="button" data-bs-toggle="tooltip"
