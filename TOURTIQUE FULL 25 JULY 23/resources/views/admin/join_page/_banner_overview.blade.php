        ...
        <div class="col-lg-3 mt-2">
            <div class="avatar shadow-sm img-thumbnail position-relative blog-image-cls">
                <div class="h-100 w-100  overflow-hidden position-relative">
                    <img src="{{ $GBO['image'] != '' ? asset('uploads/join_page/banner_overview/' . $GBO['image']) : asset('uploads/placeholder/placeholder.png') }}" id="overview_image_<?php echo $overview_count; ?>" width="100" alt="" /> 
                </div>
            </div>
        </div>
    </div> 
