...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="col-auto ms-auto">
            <a class="btn btn-falcon-primary me-1 mb-1 mt-1" href="{{ route('admin.testimonials.add') }}" type="button"><span
                                    ...
                                    <tbody>
                                        ...
                                        @if (!$get_testimonial->isEmpty())
                                            @foreach ($get_testimonial as $key => $value)
                                                <tr>
                                                    <td>{{ $key + $get_testimonial->firstItem() }}</td>
                                                    <td>{{ $value['name'] }}</td>
                                                    ...
                                                    <td class="text-end">
                                                        <div>
                                                            <a class="btn p-0"
                                                                href="{{ route('admin.testimonials.edit', encrypt($value['id'])) }}"
                                                            ...
                                                            <a class="btn p-0" onclick="return doconfirm();"
                                                                href="{{ route('admin.testimonials.delete', encrypt($value['id'])) }}"
                                                                type="button" data-bs-toggle="tooltip"
