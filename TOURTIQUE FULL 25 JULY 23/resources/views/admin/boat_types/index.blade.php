...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="col-auto ms-auto">
            <a class="btn btn-falcon-primary me-1 mb-1 mt-1" href="{{ route('admin.boat_types.add') }}" type="button">
                ...
                <div class="card-body pt-0">
                    <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                            ...
                            <div class="table-responsive scrollbar">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
                                            <th scope="col">{{ translate('Boat Type') }}</th>
                                    ...
                                    <tbody>
                                        <?php $i = 1; ?>
                                        @if (!$get_boat_types->isEmpty())
                                            @foreach ($get_boat_types as $key => $value)
                                                <tr>
                                                    <td>{{ $key + $get_boat_types->firstItem() }}</td>
                                                    ...
                                                    <td class="text-end">
                                                        <div>
                                                            <a class="btn p-0"
                                                                href="{{ route('admin.boat_types.edit', encrypt($value['id'])) }}"
                                                            ...
                                                            <a class="btn p-0" onclick="return doconfirm();"
                                                                href="{{ route('admin.boat_types.delete_boat_types', encrypt($value['id'])) }}"
                                                                type="button" data-bs-toggle="tooltip"
                            ...
                            <div>
                                {{ $get_boat_types->appends(request()->query())->links() }}
                            </div>
                        </div>
                    </div>
                </div>
