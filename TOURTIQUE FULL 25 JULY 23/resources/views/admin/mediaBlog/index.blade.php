...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="col-auto ms-auto">
            <a class="btn btn-falcon-primary me-1 mb-1 mt-1" href="{{ route('admin.media_blogs.add') }}" type="button"><span
                ...
                <div class="card-body pt-0">
                    <div class="tab-content">
                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @if (!$get_media_blog->isEmpty())
                                            @foreach ($get_media_blog as $key => $value)
                                                <tr>
                                                    <td>{{ $key + $get_media_blog->firstItem() }}</td>
                                                    ...
                                                    <td class="text-end">
                                                        <div>
                                                            <a class="btn p-0"
                                                                href="{{ route('admin.media_blogs.edit', encrypt($value['id'])) }}"
                                                            ...
                                                            <a class="btn p-0" onclick="return doconfirm();"
                                                                href="{{ route('admin.media_blogs.delete', encrypt($value['id'])) }}"
                                                                type="button" data-bs-toggle="tooltip"
                            ...
                            <div>
                                {{ $get_media_blog->appends(request()->query())->links() }}
                            </div>
                        </div>
                    </div>
                </div>
