          ...
          <div class="col-md-6">
            ...
            <form role="form" id="evaluationedit" action="" method="post" enctype="multipart/form-data"  accept-charset="utf-8" name="formname">
                <div class="box-body">
                    ...
                    <?php if($cropview!=''){ ?>
                      <?php if(!@$_GET['Internalseedcode']==''){ ?>
                        <div class="text-success"><?php echo 'Valid Code for : '.$crops_title.'<br> Location Is: ' .$location.'<br> Receiver Is: '. $Receiver_name; ?></div>
                      <?php } ?>
                      ...
                      <?php if($get_single_evaluation['CheckInternalsamplecodecontrolvariety']!=''){ ?>
                        <div class="form-group <?php if($error['Internalsamplecodecontrolvariety']!=''){ echo 'has-error'; } ?>" 
                          ...
                          <input type="text" class="form-control" id="Internalsamplecodecontrolvariety" name="Internalsamplecodecontrolvariety" placeholder="Internal sample code control variety" value="<?php echo $get_single_evaluation['Internalsamplecodecontrolvariety']; ?>">
                      ...
                      <?php } ?>
          						...
          						<div class="form-group <?php if($error['Dateofvisit']!=''){ echo 'has-error'; } ?>" id="InputDateofvisit">
          						  ...
          						  <input type="text" class="form-control" id="Dateofvisit" name="Dateofvisit" placeholder="Date of visit" value="<?php echo $get_single_evaluation['Dateofvisit']; ?>">
                    ...
                    <?php if($cropview!=''){ ?>
                    	<div class="form-group" >
                                ...
                                <?php } ?>
                                  ...
                                  <td class="text-center" width="10%"></td><td class="text-center" width="20%"><button type="button" class="btn btn-danger btn-sm" id="delete" title="Delete file">Delete file</button></td></tr>
          						      <?php
          						            $i++;
          						          }
          						        }
                      ...
                      <?php if($get_single_evaluation['CheckInternalsamplecodecontrolvariety']!=''){ ?>
              						<div class="form-group <?php if($error['Status']!=''){ echo 'has-error'; } ?>" id="InputStatus">
              						  ...
              						  <?php foreach ($Status as $key => $value){ ?>
              						    <?php 
              						      if($get_single_evaluation['Status']==$value){
              						...
              						<div class="form-group <?php if($error['Dropmessage']!=''){ echo 'has-error'; } ?>" id="InputDropmessage" <?php echo $styleDropmessage; ?> >
              						  ...
              						  <textarea  type="text" class="form-control" id="Dropmessage" name="Dropmessage" placeholder="Dropmessage" ><?php echo $get_single_evaluation['Dropmessage']; ?></textarea>
              						...
              						<div class="form-group <?php if($error['ByWhen']!=''){ echo 'has-error'; } ?>" id="InputByWhen" <?php echo $styleByWhenmessage; ?>>
              						  ...
              						  <input type="text" class="form-control" id="ByWhen" name="ByWhen" placeholder="By When" value="<?php echo $get_single_evaluation['ByWhen']; ?>">
                            ...
                            ?>
              						  ...
              						  <input type="number" class="form-control" id="Numberofseeds" name="Numberofseeds" placeholder="Number of seeds" value="<?php echo $get_single_evaluation['Numberofseeds']; ?>">
...
<script type="text/javascript">
  $(document).ready(function(){
    $( "#Dateofvisit" ).datepicker({ dateFormat: "dd/mm/yy" });
