         ...
         <div class="row">
            <div class="col-md-12">
               <div class="box box-primary">
                  <!-- form start -->
                  <form role="form" id="evaluationreport" action="<?php echo base_url(); ?>admin/reportevaluation/<?php echo $_GET['EvaluationID']; ?>" method="post" enctype="multipart/form-data"  accept-charset="utf-8" name="formname">
                     <div class="box-body">
                              ...
                              <div class="boximgselect" id="boximgselectPicture_1_<?php echo $i; ?>">
                                 <img src="<?php echo $Picture['thumbnail']; ?>" class="gallery_img" id="Picture_1_<?php echo $i; ?>">
                                  <?php 
                                    ...
                                    // $image_name = explode('_', $AddDate);
                                    //  print_r($image_name);
                                    // @$newimage_name = @$image_name[2].'-'.@$image_name[3].'-'.@$image_name[4];
                                    ?> 
                     ...
                     <div class="box-footer">
                        <a href="<?php echo base_url(); ?>admin/reportevaluation/14"><i class="fa fa-file" aria-hidden="true" style="display: none;"></i></a>
                        <br>
