        ...
        <div class="row">
            <div class="col-md-12">
               <div class="samples-filter">
                  <form method="get" action="<?php echo base_url(); ?>admin/trial" id="filterform">
                    <div class="row">
                      <div class="col-md-2">
            ...
            <div class="col-md-12">
               <div class="samples-filtered">
                  <form method="get" action="<?php echo base_url(); ?>admin/trial" id="filterform">
                    <div class="row">  
                      <div class="col-md-2">
                          <input type="text" class="form-control"id="Internalsamplingcode"  name="Internalsamplingcode" placeholder="Internal code" value="<?php if(isset($Internalsamplingcode)){ echo $Internalsamplingcode; } ?>" autocomplete="off">
                      </div>
                      <div class="col-md-4">
                          <button type="submit" style="padding: 6px 20px;" class="btn btn-primary">Filter</button>
                      </div>    
              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                  <tr>
                    ...
                    <th>Added By</th>
                    <th>Added Date</th>
                    <?php if($userrole=='1' || $userrole=='2' || $userrole=='4' || $userrole=='3'){  ?>
                  ...
                  <?php foreach ($trial as $value) { ?>
                    <?php 
                      if(@$value['trial_AddedDate'] != ''){
                        $newAddDate = $value['trial_AddedDate'];
                        @$NewTrailaddedDate = date("d-F-Y",strtotime($newAddDate));
                        }else{
                       @$NewTrailaddedDate = '';
                      }
                      ...
                      if(@$value['AddedDate'] != ''){
                        ...
                        @$NewAddedDate = date("d-F-Y",strtotime($newAddDate));
                        }else{
                       @$NewAddedDate = '';
                      }
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php if($Crop || $Supplier || $Variety || $Location || $Techncialteam || $FromDate || $ToDate || $SowingFromDate || $SowingToDate || $HarvestFromDate || $HarvestToDate || $TransplantFromDate || $TransplantToDate || $Internalsamplingcode) {
                           echo @$NewTrailaddedDate;
                        }else{
                          echo @$NewAddedDate;
                        }  ?></td>
                        <?php if($userrole=='1' || $userrole=='4' || $userrole=='2' || $userrole=='3'){  ?>
                        <td>
                        ...
                        <td>
                          ...
                          <?php if ($value['latitude']!='') { ?>
                            <a href="<?php echo base_url(); ?>admin/triallocation/?TrialID=<?php echo $value['TrialID']; ?>"><button type="button" class="btn btn-default">View Location</button></a>
                          <?php  } ?>
