                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group" id="Inputuserrole">
                      ...
                      <select id="userrole" name="userrole" class="form-control">
                          <option value="3">See Only</option>
                          <option value="2">Editor</option>
                          <option value="4">Manager</option>
                          <option value="5">APP User</option>
                          <option value="6">Trail User</option>
                          <option value="7">App and Web</option>
                      </select>
                      <span class="help-block"></span>
                    </div>
                    <div class="form-group" id="Inputuserpermissions">
                      <label for="userpermissions" class="">User Permission</label><br>
                      <?php foreach ($modules as $key => $value) { ?>
                      <input style="margin: 0 10px;" type="checkbox" name="userpermission[]" value="<?php echo $key; ?>" id="userpermission<?php echo $key; ?>" class="userpermission<?php echo $key; ?>"><label for="userpermission<?php echo $key; ?>" class="userpermission<?php echo $key; ?>"><?php echo $value; ?></label>
                      <?php } ?>
                      <span class="help-block"></span>
                    </div>
...
$(document).ready(function(){  
  $("#userrole").on("change", function (){
      ...
      if(userrole=='4'){
        $('#Inputuserpermissions').hide();
      }else{
        $('#Inputuserpermissions').show();
