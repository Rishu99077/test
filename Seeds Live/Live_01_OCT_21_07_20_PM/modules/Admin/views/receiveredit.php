                ...
                <form role="form" id="receiveredit" action="" method="post" enctype="multipart/form-data"  accept-charset="utf-8" name="formname">
                  <div class="box-body">
                    <div class="form-group <?php if($error['Name']!=''){ echo 'has-error'; } ?>" id="InputName">
                      ...
                      <input type="text" class="form-control" id="Name" name="Name" placeholder="Name" value="<?php echo $get_receiver['Name']; ?>">
                    ...
                    <div class="form-group <?php if($error['Activity']!=''){ echo 'has-error'; } ?>" id="InputActivity">
                      ...
                      <input type="text" class="form-control" id="Activity" name="Activity" placeholder="Activity" value="<?php echo $get_receiver['Activity']; ?>">
                    ...
                    <div class="form-group <?php if($error['Province']!=''){ echo 'has-error'; } ?>" id="InputProvince">
                      ...
                      <input type="text" class="form-control" id="Province" name="Province" placeholder="Province" value="<?php echo $get_receiver['Province']; ?>">
                    ...
                    <div class="form-group <?php if($error['Telphone1']!=''){ echo 'has-error'; } ?>" id="InputTelphone1">
                      ...
                      <input type="text" class="form-control" id="Telphone1" name="Telphone1" placeholder="Telphone 1" value="<?php echo $get_receiver['Telphone1']; ?>">
                    ...
                    <div class="form-group <?php if($error['Telphone2']!=''){ echo 'has-error'; } ?>" id="InputTelphone2">
                      ...
                      <input type="text" class="form-control" id="Telphone2" name="Telphone2" placeholder="Telphone 2" value="<?php echo $get_receiver['Telphone2']; ?>">
                    ...
                    <div class="form-group <?php if($error['Mobile1']!=''){ echo 'has-error'; } ?>" id="InputMobile1">
                      ...
                      <input type="text" class="form-control" id="Mobile1" name="Mobile1" placeholder="Mobile 1" value="<?php echo $get_receiver['Mobile1']; ?>">
                    ...
                    <div class="form-group <?php if($error['Mobile2']!=''){ echo 'has-error'; } ?>" id="InputMobile2">
                      ...
                      <input type="text" class="form-control" id="Mobile2" name="Mobile2" placeholder="Mobile 2" value="<?php echo $get_receiver['Mobile2']; ?>">
                      ...
                      <table id="table" class="table1" width="100%" style="margin: 0 auto;">
                        ...
                        <tbody class="tbodyAddress">
                          ...
                          foreach($get_Address as $value){ ?>
                            <tr class="add_row"><td ><textarea  name="Address[]" type="text" id="Address" placeholder="Address" /><?php echo $value; ?></textarea></td><td class="text-center"><button type="button" class="btn btn-danger btn-sm" id="delete" title="Remove">Remove</button></td></tr>
                          <?php  } ?>
                        </tbody>
                        <tfoot>  
                          <tr>
                            <td colspan="4"><button class="btn btn-success btn-sm" type="button" id="addAddress" title='Add new'/>Add new</button></td>
                          </tr>
                        </tfoot>  
                      </table>
                      ...
                      <table id="table" class="table1" width="100%" style="margin: 0 auto;">
                        ...
                        <tbody class="tbodyLocation">
                          ...
                          foreach($get_Location as $value){ ?>
                            <tr class="add_row"><td ><textarea  name="Location[]" type="text" id="Location" placeholder="Location"/><?php echo $value; ?></textarea></td><?php if($userrole=='1') { ?><td class="text-center"> 
                              <button type="button" class="btn btn-danger btn-sm" id="delete" title="Remove">Remove</button><?php }?> </td></tr>
                          <?php  } ?>
                        </tbody>
                        <tfoot>  
                          <tr>
                            <td colspan="4"><button class="btn btn-success btn-sm" type="button" id="addLocation" title='Add new'/>Add new</button></td>
                          </tr>
                        </tfoot>  
                      </table>
                    ...
                    <div class="form-group" id="InputNote">
                      ...
                      <textarea class="form-control" id="Note" name="Note" placeholder="Note"><?php echo $get_receiver['Note']; ?></textarea>
