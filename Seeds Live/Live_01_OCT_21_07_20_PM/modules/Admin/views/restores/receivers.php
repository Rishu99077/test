              ...
              <?php if(count($module_data) > 0) { ?>
		          ...
		          <?php foreach ($module_data as $value) { ?>
		              <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url(); ?>admin/restore/delete/receivers/<?php echo $value['ReceiverID']; ?>"><button type="button" class="btn btn-danger" onClick="return doconfirm();">Permanently Delete</button>
                                </a>
                            <a href="<?php echo base_url(); ?>admin/restore/restore/receivers/<?php echo $value['ReceiverID']; ?>"><button type="button" class="btn btn-success">Restore</button></a>
                        </td>
		              </tr>
		          <?php $cnt++; }  ?>
              <?php }else{ ?>
