        ...
        <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <!-- form start -->
                <form role="form" id="update_profile" action="" method="post" enctype="multipart/form-data"  accept-charset="utf-8" name="formname">
                  <div class="box-body">
                    ...
                    <div class="form-group" id="InputUser_profile_show" style="float: left;width: 100%;">
                            <img style="width: 100px;" class="img-responsive" src="<?php echo base_url('uploads/UserProfile/thumbnail/'.$user['image']); ?>">
                    </div>
                    <?php } ?>
